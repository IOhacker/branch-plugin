...
import org.apache.fineract.branch.connector.service.FineractRepaymentGateway;
...
import org.apache.fineract.branch.connector.data.BranchContextData;
...
class BranchPaymentServiceIdempotencyTest {
    ...
    void differentAmountOnSameExternalIdRaisesConflict() {
        ...
        var repaymentReq = org.apache.fineract.branch.connector.data.RepaymentRequestData.builder()
