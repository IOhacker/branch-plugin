 ...
 *
 * Local audit trail of branch payments. Guarantees idempotency via externalId
 * and supports reconciliation / UNKNOWN state resolution.
 */
package org.apache.fineract.branch.domain;
...
@Entity
@Table(name = "m_branch_branch_payment", uniqueConstraints = {
        @UniqueConstraint(name = "uk_branch_external_id", columnNames = "external_id") }, indexes = {
                @Index(name = "idx_branch_branch_date", columnList = "branch_id,transaction_date"),
